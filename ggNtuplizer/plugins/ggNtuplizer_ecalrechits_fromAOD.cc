...
void ggNtuplizer::branchesEcalRechits(TTree* tree) {
...
void ggNtuplizer::fillEcalRechits(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  //bool debugRH = true;
  bool debugRH = false;
  ...
  edm::Handle<ESRecHitCollection> esRecHitsHandle;
